...
export async function SubmitTest() {
  ...
  var axiosObject = {};
  axiosObject[examID] = {
    questions: { ...fullstore.questions },
    property: { ...fullstore.property },
  };
  ...
  try {
    await axios.patch(
      "https://mcq-app-6cef8-default-rtdb.firebaseio.com/test/exams.json",
      axiosObject
    );
    await axios.patch(
      "https://mcq-app-6cef8-default-rtdb.firebaseio.com/test/answers.json",
      axiosAnswerObject
    );
  } catch (e) {
    console.log(e);
...
export async function getExamID() {
  ...
  while (!isAlright) {
    ...
    var url =
      "https://mcq-app-6cef8-default-rtdb.firebaseio.com/test/exams/" +
      id +
      ".json";
